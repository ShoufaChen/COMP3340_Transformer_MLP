...
def single_gpu_test(model,
    ...
    for i, data in enumerate(data_loader):
        with torch.no_grad():
            ...
            result = [i.cpu().numpy() for i in result]
...
def main():
    ...
    if not distributed:
        ...
        outputs = single_gpu_test(model.module.backbone, data_loader, args.show, args.show_dir,
                                  **show_kwargs)
    else:
        ...
        outputs = multi_gpu_test(model.module.backbone, data_loader, args.tmpdir,
                                 args.gpu_collect)
    import numpy as np
